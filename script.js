/* Exercise 1: Write a JavaScript program to check two numbers and return
        true if one of the number is 100 or if the sum of the two numbers is 100 aaaa */
...
//Costas 1
checkNumbersCostas = (num1, num2) => {
  num1 === 100 || num2 === 100 || num1 + num2 === 100;
};

//Costas 2
equalTo100 = (num1, num2) => [num1, num2, num1 + num2].includes(100);
...
function typeOfFile() {
  const filePath = document.getElementById("filetype").value;
  document.getElementById("result2").innerHTML = filePath.slice(
...
function today() {
  ...
  document.getElementById(
    "date"
  ).innerHTML = `${fullmonth}-${fullday}-${year} , ${fullmonth}/${fullday}/${year}`;
}
today();
...
//Costas format it to work for your solution from the above
